...
import com.nannong.mall.activity.mine.RechargeSuccessActivity;
    ...
    public void onClick(View v)
    {
        switch (v.getId())
        {
            ...
            case R.id.ye_rl:
                if (ye_cb.isChecked())
                {
                    ye_cb.setChecked(false);
                }
                else
                {
                    ye_cb.setChecked(true);
                }
                break;
        }
