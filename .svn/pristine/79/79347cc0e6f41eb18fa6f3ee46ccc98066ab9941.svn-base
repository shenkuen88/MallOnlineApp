 ...
 * 我参与的拼团
 */
public class JoinedTeamBuyActivity extends BaseActivity implements View.OnClickListener
{
    ...
    {
        lvAdapter = new CommonAdapter<NoticeListResponse.NoticeListBean>(mContext, datas, R.layout.item_joined_team_buy)
        {
            @Override
