package com.nannong.mall.adapter.cart;
...
import com.nannong.mall.response.cart.GoodsBean;
import com.nannong.mall.response.cart.StoreBean;
import com.nannong.mall.response.cart.StoreGoodsBean;
...
import cn.nj.www.my_module.network.NetWork;
    ...
    private class MyOnClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            clist.add(new CartResponse.CartRecord(goodsBean.getCreateTime(), goodsBean.getUserID(), goodsBean.getPicUrl(), goodsBean.getPrice(),
                    ...
                    goodsBean.getSize()));
            setCartNum(clist, CartNumResponse.class.getName());
        }
    }
    /**
     * 修改购物车数量
