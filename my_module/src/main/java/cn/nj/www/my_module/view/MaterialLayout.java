...
public class MaterialLayout extends RelativeLayout {
    ...
    private void initTypedArray(Context context, AttributeSet attrs) {
        final TypedArray typedArray = context.obtainStyledAttributes(attrs,
                R.styleable.MaterialLayout11);
        mCirclelColor = typedArray.getColor(R.styleable.MaterialLayout11_mcolor, Color.LTGRAY);
        mDuration = typedArray.getInteger(R.styleable.MaterialLayout11_duration,
                DEFAULT_DURATION);
        mFrameRate = typedArray
                .getInteger(R.styleable.MaterialLayout11_framerate, DEFAULT_FRAME_RATE);
        mColorAlpha = typedArray.getInteger(R.styleable.MaterialLayout11_alpha, DEFAULT_ALPHA);
        mCircleScale = typedArray.getFloat(R.styleable.MaterialLayout11_scale, DEFAULT_SCALE);
